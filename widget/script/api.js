	...
	u.loadingWin = function(){
		...
		UILoading.keyFrame({
            ...
            styles: {
            	...
            	{frame: 'widget://res/loading1.png'},
            	{frame: 'widget://res/loading2.png'},
            	{frame: 'widget://res/loading3.png'},
            	{frame: 'widget://res/loading4.png'},
            	{frame: 'widget://res/loading5.png'},
            	{frame: 'widget://res/loading6.png'},
            	{frame: 'widget://res/loading7.png'},
            	{frame: 'widget://res/loading8.png'},
            	{frame: 'widget://res/loading9.png'},
            	{frame: 'widget://res/loading10.png'},
            	{frame: 'widget://res/loading11.png'},
            	{frame: 'widget://res/loading12.png'},
            ]
        }, function(ret){
            //alert(JSON.stringify(ret));
        });
	}
	u.closeLoadingWin = function(){
		if(UILoading)UILoading.closeKeyFrame();
	}

  u.pullDown = function(cb){
